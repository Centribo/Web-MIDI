...
expected.</p>
  ...
  resize(width, height) {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.vexFlowCanvasContext.resize(<span class="hljs-built_in">parseInt</span>(width, <span class="hljs-number">10</span>), <span class="hljs-built_in">parseInt</span>(height, <span class="hljs-number">10</span>));
  }
