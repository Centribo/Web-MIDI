...
extends into the beams.</p>
    ...
    <span class="hljs-keyword">const</span> firstNote = notes[<span class="hljs-number">0</span>];
    <span class="hljs-keyword">let</span> firstStemTipY = firstNote.getStemExtents().topY;</pre></div>
        
      
        
        <p>If rendering flat beams, and an offset exists, set the y-coordinat`e to
 the offset so the stems all end at the beam offset.</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">if</span> (flat_beams &amp;&amp; flat_beam_offset) {
